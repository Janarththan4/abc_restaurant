...
<html lang="en">
    <head>
        ...
        <title>Admin DashBoard | Reservation Cancel Page</title>
        <link rel="stylesheet" 
        ...
        <div class="container form-container">
            ...
            <form id="createAppointment" action="DeleteAppointmentServlet" method="post" >
                <table border="0" align="center">
                    ...
                    <tr>
                        <td>
                            <label for="fname"><b>Staff</b></label>
                        </td>
                        <td>
                            <div class="dropdown">
                        ...
                        <td>
                            <label for="lname"><b>Customers</b></label>
                        </td>
                        <td>
                            <div class="dropdown">
                    ...
                    <tr>
                        <td>
                            <label for="appointment_date"><b>Reservation Date</b></label>
                        </td>
                        <td>
                        ...
                        <td>
                            <label for=">appointmentTime"><b>Reservation Time</b></label>
                        </td>
                        <td>
