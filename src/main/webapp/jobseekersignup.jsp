...
<html>
    <head>
        <title>MultiUserLogin | Customer Signup Page</title>
    ...
    <body>
        ...
        <div class="container form-container">
            ...
            <form id="registrationForm" action="Jobseekersignupservlet" method="post">
                ...
                <br>
                <button class="create-account-button" type="button" onclick="window.location.href = 'consultantsignup.jsp';">Create an Account - Staff</button>
