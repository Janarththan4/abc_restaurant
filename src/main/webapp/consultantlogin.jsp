...
<html>
    <head>
        ...
        <title>ABC Restaurant | Staff Login</title>
    ...
    <body>
        ...
        <div class="MultiUser-Login">
            <div class="form-container">
                <form action="Consultantservlet" method="post">
                    ...
                    <br><a class="form-link-button" href="consultantsignup.jsp">Navigate to Sign Up</a>
