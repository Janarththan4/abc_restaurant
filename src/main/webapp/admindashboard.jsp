...
<html>
    ...
    <body>
        <header>
            <h1>Welcome to The ABC Restaurant - Admin</h1>
        </header>
        <div class="flex-container reverse">
            <div class="navbar">
                <nav>
                    <ul>
                        ...
                        <li><a href="javascript:void(0);" onclick="toggleSection('consultant-details')"> Staff Management </a></li >
                        <li><a href="javascript:void(0);" onclick="toggleSection('job-seeker-details')">Customer Management</a></li>
                        <li><a href="javascript:void(0);"onclick="toggleSection('appointment-details')">Reservation Management</a></li>
            ...
            <section class="section" id="consultant-details">
                ...
                <div class="flex-container">
                    <div class="user-table">
                        <a  href="createConsultant.jsp">Add Staff </a>
                        <br> <br>
                        <table class="table">
                            <thead>
                                <tr>
            ...
            <section class="section" id="job-seeker-details">
                ...
                <div class="flex-container">
                    <div class="user-table">
                        <a  href="createJobseeker.jsp">Add Customer </a>
                        <br><br>
                        <table class="table">
                            <thead>
                                <tr>
            ...
            <section class="section" id="appointment-details">
                ...
                <div class="flex-container">
                    <div class="user-table">
                        <a href="createAppointment.jsp">Add Reservation</a>
                        <br><br>
                        <table>
                            <thead>
                                <tr>
