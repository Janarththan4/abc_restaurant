...
<html>
    <head>
        ...
        <title>ABC Restaurant | Multi-User Login</title>
        ...
        <div class="MultiUser-Login">
            <div class="form-container">
                <form>
                    ...
                    <button class="create-account-button" type="button" onclick="window.location.href = 'consultantlogin.jsp';">Log In Account - Staff</button>
                    <button class="create-account-button" type="button" onclick="window.location.href = 'jobseekerlogin.jsp';">Log In Account - Customer</button>
                </form>
            </div>
        </div>
