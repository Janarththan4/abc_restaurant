...
<html lang="en">
    <head>
        ...
        <title>Admin DashBoard | Delete Staff</title>
    ...
    <body>
        ...
        <div class="container form-container">
            ...
            <form id="registrationForm" action="DeleteConsultantServlet" method="post">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        <label for="searchCountries"><b>Working Type </b></label>
