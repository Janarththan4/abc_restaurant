...
@WebServlet("/CreateJobseekerServlet")
public class CreateJobseekerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (Connection connection = dbconnect.getConn()) {
            ...
            if (success) {
                ...
                request.getRequestDispatcher("createJobseeker.jsp").forward(request, response);
            }
        } catch (Exception e) {
